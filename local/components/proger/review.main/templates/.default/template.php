...
<?php if (!empty($arResult["ITEMS"]) && count($arResult["ITEMS"]) > 0) : ?>
    <div class="review__wrapper reviews-main swiper">
        <div class="swiper-wrapper">
            <? foreach ($arResult["ITEMS"] as $arItem): ?>
                <div class="swiper-slide review" id="<?= $arItem['ID'] ?>" itemscope itemprop="review"
                     itemtype="http://schema.org/Review">

                    <div class="review__pans-wrapper">
                        <div class="review__pans-img">
                            <?
                            $file = CFile::ResizeImageGet($arItem['PANS']['PREVIEW_PICTURE'], ['width' => 256, 'height' => 256], BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true);
                            ?>
