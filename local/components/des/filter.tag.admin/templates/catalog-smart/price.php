                ...
                <div class="slider-inputs">
                    <div class="slider-inputs__item">
                        ...
                        <input type="text" class="slider-input slider-input-start" id="slider-input-start<?=$arItem["ID"]?>"
                               ...
                               value="<?=$curMinPrice?>"
                        >
                        <input type="hidden" value="<?= $curMinPrice ?>" name="<?= $arItem["VALUES"]["MIN"]["CONTROL_NAME"] ?>-default" class="slider-input-start-def">
                    </div>
                    <div class="slider-inputs__item">
                        до
                        <input type="text" class="slider-input slider-input-end" id="slider-input-end<?=$arItem["ID"]?>"
                               ...
                               value="<?=$curMaxPrice?>"
                        >
                        <input type="hidden" value="<?= $curMaxPrice ?>" name="<?= $arItem["VALUES"]["MAX"]["CONTROL_NAME"] ?>-default" class="slider-input-end-def">
                    </div>
                </div>
