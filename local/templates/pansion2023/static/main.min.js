...
"use strict";$("body").on("submit","#addNew",function(e){e.preventDefault();var t,r=$(this),a=!1,e=(["adres","price","phone","mest","site"].forEach(function(e){e=r.find('input[name="'+e+'"]');""==e.val()&&(e.addClass("error"),a=!0)}),r.find('input[name="agree"]'));if(e.prop("checked")||(e.addClass("error"),a=!0),!a)return r.find("button").attr("disabled","disabled"),grecaptcha.ready(function(){grecaptcha.execute("6LchYzcqAAAAAAKsctUoKXHZGf9JdCrIAF2vBwQh",{action:"send_form"}).then(function(e){(t=r.serializeArray())[t.length]={name:"token",value:e},$.ajax({type:"POST",url:url,data:$(this).serializeArray(),timeout:timeout,dataType:"json",error:function(e,t){r.find("button").removeAttr("disabled"),"timeout"==t?alert(error_timeout):alert(error_default)},success:function(e){"ok"==e.msg?r.html('<p style="font-size: 20px;">Спасибо! Ваше обращение принято на модерацию.</p>'):$("#addNew + p").html(e.error)}})})}),!1});
"use strict";$("body").on("submit",".js-addReview",function(e){e.preventDefault();var t,a=$(this),n=!1;if(["name","email","text","pansname"].forEach(function(e){e=a.find('input[name="'+e+'"],textarea[name="'+e+'"]');""==e.val()&&(e.addClass("error"),n=!0)}),!n)return a.find("button").attr("disabled","disabled"),grecaptcha.ready(function(){grecaptcha.execute("6LchYzcqAAAAAAKsctUoKXHZGf9JdCrIAF2vBwQh",{action:"send_form"}).then(function(e){(t=a.serializeArray())[t.length]={name:"token",value:e},$.ajax({type:"POST",url:"/local/ajax/process.php",data:t,timeout:5e3,dataType:"json",error:function(e,t){a.find("button").removeAttr("disabled"),"timeout"==t?alert("Внимание! Время ожидания ответа сервера истекло"):alert("Внимание! Произошла ошибка, попробуйте отправить информацию еще раз")},success:function(e){"ok"==e.msg?a.html('<p style="font-size: 20px;">Спасибо за Ваш отзыв!</p>'):$("#jsCallBackForm + p").html(e.error)}})})}),!1});
"use strict";function showSuccessModal(){$("#modal .content").html('<div class="success"><img src="/local/templates/pansion/img/success.svg" alt=""><h1>Спасибо!</h1><p>Ваша заявка уже на рассмотрении. \nНаш менеджер скоро свяжется с вами, чтобы ответить на все вопросы.</p><span class="close_butt">ОК</span></div>')}function checkStep(){1==window.calcCurStep?$(".calc_form_wrapper .move_back").fadeOut():$(".calc_form_wrapper .move_back").fadeIn(),$("#cur_step").html(window.calcCurStep),6==window.calcCurStep&&($(".calc_form_wrapper .move_back").fadeOut(),$(".calc_form_wrapper .move_formard").fadeOut(),$(".calc_form_wrapper button").fadeIn(),$(".calc_form_wrapper h2").html("Введите номер телефона, мы вышлем на него информацию или перезвоним."),$(".calc_form_wrapper p.steps").html("")),$("#step"+window.calcCurStep+" input[type=radio]:checked").val()?$(".calc_form_wrapper .move_formard").removeClass("disabled"):$(".calc_form_wrapper .move_formard").addClass("disabled")}function showNextStep(){$("#step"+window.calcCurStep).removeClass("active").addClass("prev"),window.calcCurStep+=1,$(".steps_wrapper").height(335),$("#step"+window.calcCurStep).removeClass("next").addClass("active"),checkStep()}function showPrevStep(){1<window.calcCurStep&&($("#step"+window.calcCurStep).removeClass("active").addClass("next"),--window.calcCurStep,$(".steps_wrapper").height(335),$("#step"+window.calcCurStep).removeClass("prev").addClass("active"),checkStep())}window.calcCurStep=1,$(".steps_wrapper").height(335),$("body").on("click",".calc_form_wrapper .move_formard",function(e){$(this).hasClass("disabled")||showNextStep()}),$("body").on("click",".calc_form_wrapper .move_back",function(e){showPrevStep()}),$("body").on("change",".step.active input[type=radio]",function(e){setTimeout(function(){showNextStep()},400)}),$("body").on("submit","#jsMakeCalc",function(e){e.preventDefault();var a,t=$(this),c=!1,r=$(this).attr("data-metrika");if(["phone"].forEach(function(e){e=t.find('input[name="'+e+'"]');""==e.val()&&(e.addClass("error"),c=!0)}),!c)return t.find("button").attr("disabled","disabled"),grecaptcha.ready(function(){grecaptcha.execute("6LchYzcqAAAAAAKsctUoKXHZGf9JdCrIAF2vBwQh",{action:"send_form"}).then(function(e){(a=t.serializeArray())[a.length]={name:"token",value:e},$.ajax({type:"POST",url:url,data:a,timeout:timeout,dataType:"json",error:function(e,a){t.find("button").removeAttr("disabled"),"timeout"==a?alert(error_timeout):alert(error_default)},success:function(e){"ok"==e.msg?(showSuccessModal(),yaCounter55993486.reachGoal(r)):$("#jsCallBackForm + p").html(e.error)}})})}),!1});
"use strict";function showSuccessModal(){$("#modal .content").html('<div class="success"><img src="/local/templates/pansion/img/success.svg" alt=""><h1>Спасибо!</h1><p>Ваша заявка уже на рассмотрении. \nНаш менеджер скоро свяжется с вами, чтобы ответить на все вопросы.</p><span class="close_butt js-close-modal">ОК</span></div>')}$("body").on("focus","input.error",function(){$(this).removeClass("error")}),$("body").on("change","input.error",function(){$(this).removeClass("error")});var timeout=5e3,url="/local/ajax/process.php",error_timeout="Внимание! Время ожидания ответа сервера истекло",error_default="Внимание! Произошла ошибка, попробуйте отправить информацию еще раз";document.addEventListener("DOMContentLoaded",function(){$("form").find("input[name=client_ids]").val(yaCounter55993486.getClientID())}),$("body").on("submit","#jsCallBackForm",function(t){t.preventDefault();var e,a=$(this),o=!1,r=$(this).attr("data-metrika");if(["phone"].forEach(function(t){t=a.find('input[name="'+t+'"]');""==t.val()&&(t.addClass("error"),o=!0)}),!o)return a.find("button").attr("disabled","disabled"),grecaptcha.ready(function(){grecaptcha.execute("6LchYzcqAAAAAAKsctUoKXHZGf9JdCrIAF2vBwQh",{action:"send_form"}).then(function(t){(e=a.serializeArray())[e.length]={name:"token",value:t},$.ajax({type:"POST",url:url,data:e,timeout:timeout,dataType:"json",error:function(t,e){a.find("button").removeAttr("disabled"),"timeout"==e?alert(error_timeout):alert(error_default)},success:function(t){"ok"==t.msg?(showSuccessModal(),yaCounter55993486.reachGoal(r)):$("#jsCallBackForm + p").html(t.error)}})})}),!1}),$("body").on("submit","#jsTakeRent",function(t){t.preventDefault();var e,a=$(this),o=!1;["phone"].forEach(function(t){t=a.find('input[name="'+t+'"]');""==t.val()&&(t.addClass("error"),o=!0)}),o||(a.find("button").attr("disabled","disabled"),grecaptcha.ready(function(){grecaptcha.execute("6LchYzcqAAAAAAKsctUoKXHZGf9JdCrIAF2vBwQh",{action:"send_form"}).then(function(t){return(e=a.serializeArray())[e.length]={name:"token",value:t},$.ajax({type:"POST",url:url,data:e,timeout:timeout,dataType:"json",error:function(t,e){a.find("button").removeAttr("disabled"),"timeout"==e?alert(error_timeout):alert(error_default)},success:function(t){"ok"==t.msg?(showSuccessModal(),yaCounter55993486.reachGoal("button_9")):$("#jsCallBackForm + p").html(t.error)}}),!1})}))}),$("body").on("submit","#main_form",function(t){t.preventDefault();var a=$(this);return a.find("button").attr("disabled","disabled"),$.ajax({type:"POST",url:"/local/ajax/getPansion.php",data:a.serializeArray(),timeout:timeout,dataType:"json",error:function(t,e){a.find("button").removeAttr("disabled"),"timeout"==e?alert(error_timeout):alert(error_default)},success:function(t){window.clusterer.removeAll(),setTimeout(function(){t.items&&t.items.forEach(function(t){window.clusterer.add(new ymaps.Placemark(t.coords,{balloonContentHeader:"",balloonContentBody:'<div class="in_map"> <a href = "'+t.url+'"><img src="'+t.picsrc+'" height="150"></a><br/><a href = "'+t.url+'">'+t.name+'</a><br><p class="rating_line">'+t.rating_html+'</p><br><p class="price"> Цена: '+t.price+' руб./сутки</p><span class="fiol_button js-show-modal" data-modal="takerent" data-id="'+t.id+'">Забронировать</span></div>',hintContent:t.name},{preset:"islands#icon",iconColor:"#663ab6"}))}),$([document.documentElement,document.body]).animate({scrollTop:$("#map").offset().top},500),a.find("button").removeAttr("disabled")},100)}}),!1}),$("body").on("click","#main_form #clear_filter",function(){$("select[name=napr]").val(""),$("select[name=section_id]").val(""),$("select[name=fizsost]").val(""),$("select[name=psihsost]").val(""),$("input[name=rating\\[\\]]").prop("checked","")});
"use strict";
"use strict";$(".js-map-button").click(function(){$("#search_form").attr("action","/find/map/").find("button").click()});
"use strict";$("body").on("submit",".js-simpleForm",function(t){t.preventDefault();var e,r=$(this),a=!1,o=$(this).attr("data-metrika");if(["phone"].forEach(function(t){t=r.find('input[name="'+t+'"]');""==t.val()&&(t.addClass("error"),a=!0)}),!a)return r.find("button").attr("disabled","disabled"),grecaptcha.ready(function(){grecaptcha.execute("6LchYzcqAAAAAAKsctUoKXHZGf9JdCrIAF2vBwQh",{action:"send_form"}).then(function(t){(e=r.serializeArray())[e.length]={name:"token",value:t},$.ajax({type:"POST",url:url,data:e,timeout:timeout,dataType:"json",error:function(t,e){r.find("button").removeAttr("disabled"),"timeout"==e?alert(error_timeout):alert(error_default)},success:function(t){"ok"==t.msg?(yaCounter55993486.reachGoal(o),r.html('<p style="font-size: 20px;">Спасибо!<br>Наш менеджер скоро свяжется с вами, чтобы ответить на все вопросы.</p>')):$("#jsCallBackForm + p").html(t.error)}})})}),!1});
"use strict";$(".slide_img").slick({dots:!0,infinite:!0,speed:500,fade:!0,autoplay:!0,cssEase:"linear"});
