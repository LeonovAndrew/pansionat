...
//$file = CFile::ResizeImageGet($arResult['PREVIEW_PICTURE'], array('width' => 1200, 'height' => 667), BX_RESIZE_IMAGE_PROPORTIONAL, true);
...
//            $file = CFile::ResizeImageGet($pic, array('width' => 1200, 'height' => 667), BX_RESIZE_IMAGE_PROPORTIONAL, true);
//            $sliderPictures[] = array(
//                'SRC' => $file['src']
//            );
//
//        }
//    } else {
//        $file = CFile::ResizeImageGet($arResult['DISPLAY_PROPERTIES']['MORE_PHOTO']['FILE_VALUE'], array('width' => 1200, 'height' => 667), BX_RESIZE_IMAGE_PROPORTIONAL, true);
//        $sliderPictures[] = array(
//            'SRC' => $file['src']
//        );
//    }
...
//    $extraBigFile = CFile::ResizeImageGet(
//        $arResult['PREVIEW_PICTURE'],
//        array('width'=>2000, 'height'=>2000),
//        BX_RESIZE_IMAGE_PROPORTIONAL_ALT, true);

    $bigFile = CFile::ResizeImageGet(
        $arResult['PREVIEW_PICTURE'],
...
foreach ($arResult['PROPERTIES']['MORE_PHOTO']['VALUE'] as $mPhoto) {
