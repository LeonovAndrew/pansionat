...
<div class="tabs">
    <div class="tabs__wrapper">
        <div class="tabs__button __active" data-id="topTab21">Для&nbsp;пожилых</div>
        <div class="tabs__button" data-id="topTab22">Для&nbsp;ветеранов</div>
        <div class="tabs__button" data-id="topTab23">Для&nbsp;престарелых</div>
        <div class="tabs__button" data-id="topTab24">Хосписы</div>
    </div>

    <div class="tabs__content">
        <div class="tabs__item __active" id="topTab21">
            <?
        ...
        <div class="tabs__item" id="topTab22">
            <?
        ...
        <div class="tabs__item" id="topTab23">
            <?
        ...
        <div class="tabs__item" id="topTab24">
            <?
